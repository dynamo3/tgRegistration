...
<body>
	...
	<!-- Start of Header section with User Nav -->
		...
		<div class="userPopUp">
			...
			<div class="signUpTab">Sign Up</div>
			...
			<div class="userSignIn">
				<div>
					<form action="" method="">
						...
						<button class="cancelButton">Cancel</button><button class="submitButton" type="submit">Submit</button>
